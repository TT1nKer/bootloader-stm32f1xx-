...
/**
  ...
  * This function configures the hardware resources used for ADC power monitoring
...
/**
  ...
  * This function freeze the hardware resources used for ADC power monitoring
  * @param hadc: ADC handle pointer
  * @retval None
  */
